...
internal actual class NativeWriteBatchWrapper internal actual constructor(actual val native: NativeWriteBatch) {
    ...
    ): NativeWriteBatchWrapper = rethrow { js.set(documentRef.js, encodedData.wasmJs.toJsAny()!!, setOptions.js) }.let { this }

    actual fun updateEncoded(documentRef: DocumentReference, encodedData: EncodedObject): NativeWriteBatchWrapper = rethrow { js.update(documentRef.js, encodedData.wasmJs.toJsAny()!!) }
        .let { this }
