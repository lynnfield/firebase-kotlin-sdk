...
public external fun getBytes(ref: StorageReference, maxDownloadSizeBytes: Double): Promise<JsAny>

public external fun uploadBytes(ref: StorageReference, file: JsFile, metadata: JsAny?): Promise<UploadResult>
public external fun uploadBytes(ref: StorageReference, data: JsUint8Array, metadata: JsAny?): Promise<UploadResult>
public external fun uploadBytesResumable(ref: StorageReference, file: JsFile, metadata: JsAny?): UploadTask
public external fun uploadBytesResumable(ref: StorageReference, data: JsUint8Array, metadata: JsAny?): UploadTask
