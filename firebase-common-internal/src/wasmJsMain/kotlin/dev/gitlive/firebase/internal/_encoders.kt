...
/**
 * Encodes into Kotlin-native [MutableMap]/[MutableList] trees (mirroring Android/JVM), converted
 * to a JS object/array only at the JS interop boundary in firebase-firestore, since wasmJs has no
 * `dynamic`/`json()` builder to build a JS object incrementally the way js(IR) does.
 */
